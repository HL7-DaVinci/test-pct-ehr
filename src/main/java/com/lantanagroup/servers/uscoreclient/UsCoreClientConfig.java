...
@Configuration
@ComponentScan(basePackageClasses = { UsCoreClientConfig.class })
@PropertySource("classpath:uscoreclient.properties")
...
public class UsCoreClientConfig extends CommonConfig {

  @Autowired
  protected UsCoreClientProperties serverProperties;
  ...
  public ServletRegistrationBean<RestfulServer> fhirServletRegistrationBean(RestfulServer restfulServer) {
    ...
    restfulServer.registerInterceptor(new CapabilityStatementCustomizer(restfulServer.getFhirContext(), "uscoreclient"));
